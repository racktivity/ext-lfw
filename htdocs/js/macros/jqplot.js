var render = function(options) {
    ...
    var chart_title = data_dict.title || "Exponential Line2";
    ...
    if (renderer){
        ...
        renderer_path = "js/libs/jqplot/plugins/jqplot.renderer_name.js".replace("renderer_name", renderer_name)
    }
    
    console.log("redered_path : " +renderer_path);
    ...
    var cb = function(){
        ...
        var series;
        if (renderer){
             var series = {series:[{renderer:eval(renderer)}]};
        }
    ...
    if (renderer_path){
        dependencies.push(renderer_path);
    }
